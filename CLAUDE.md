...
- **Dropi**: 20 unidades totales (24 filas − 4 canceladas, sin deduplicar). 2026-07-09 (jueves) → 1 unidad, sin cambios. 2026-07-10 (viernes) → 11 unidades, sin cambios. 2026-07-11 es **sábado**, con 8 unidades crudas antes del reparto; como el lunes siguiente (2026-07-13) **sí es festivo** (Día de Nuestra Señora del Rosario de Chiquinquirá, Ley 2578 de 2026 — festivo nuevo, ver sección "Reparto de fin de semana/festivo largo"), la ventana se extiende a sábado+domingo+lunes y esas 8 se reparten entre 3 → **2026-07-11 → 2,6667**, **2026-07-12 (domingo) → 2,6667** y **2026-07-13 (lunes festivo) → 2,6667** (valor exacto guardado para que la suma cierre en 8; se muestra redondeado a 3 u. en pantalla vía `fmtUnits()`). Tienda líder total (no cambia con el reparto, es un total general): "Tiko" con 9 unidades.
...
- **KPI "Total combinado (último día)"** con esta muestra: el último día operativo con datos es 2026-07-13 (lunes festivo, generado por el reparto — antes de la Ley 2578 de 2026 hubiera sido 2026-07-12), EFFI 0 + Dropi 2,6667 = 2,6667 u. (se muestra redondeado como 3 u., faltan ~197 para la meta de 200) — no confundir con el combinado de 2026-07-10 (110 u.), que es un día distinto y no el último. Solo aplica en modo visitante (repartido); en modo administrador "real" el último día con datos sigue siendo 2026-07-11 (sábado), porque ese modo usa `A.byDateRaw`/`B.byDateRaw` sin reparto.
